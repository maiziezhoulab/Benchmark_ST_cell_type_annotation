...
# ===================== Path =====================
method_dirs <- list(
  SpatialID = "/maiziezhou_lab2/yuling/MouseSpinal/label_transfer/spatialID/0503_F4_C_metric",
  DestVI = "/maiziezhou_lab2/yuling/MouseSpinal/label_transfer/DestVI/0503_F4_C_metric",
  RCTD = "/maiziezhou_lab2/yuling/MouseSpinal/label_transfer/RCTD/0503_F4_C_metric",
  CARD = "/maiziezhou_lab2/yuling/MouseSpinal/label_transfer/CARD/0503_F4_C_metric",
  Cell2location = "/maiziezhou_lab2/yuling/MouseSpinal/label_transfer/cell2location/0503_F4_C_metric",
  GraphST = "/maiziezhou_lab2/yuling/MouseSpinal/label_transfer/GraphST/0503_F4_C_metric",
  scANVI = "/maiziezhou_lab2/yuling/MouseSpinal/label_transfer/scVI/0503_F4_C_metric",
  Seurat = "/maiziezhou_lab2/yuling/MouseSpinal/label_transfer/Seurat/0503_F4_C_metric",
  SingleR = "/maiziezhou_lab2/yuling/MouseSpinal/label_transfer/SingleR/0503_F4_C_metric",
  SpatialDWLS = "/maiziezhou_lab2/yuling/MouseSpinal/label_transfer/spatialDWLS/0503_F4_C_metric",
  SPOTlight = "/maiziezhou_lab2/yuling/MouseSpinal/label_transfer/spotlight/0503_F4_C_metric",
  TACCO = "/maiziezhou_lab2/yuling/MouseSpinal/label_transfer/tacco/0503_F4_C_metric",
  Tangram = "/maiziezhou_lab2/yuling/MouseSpinal/label_transfer/Tangram/0503_F4_C_metric"
)
...
BIG_TO_SUB <- list(
  ...
  `Dorsal Maf` = c("Dorsal Maf(1)", "Dorsal Maf(2)"),
  ...
  `Dorsal excitatory` = c("Dorsal excitatory(1)", "Dorsal excitatory(2)", "Dorsal excitatory(3)",
                          "Dorsal excitatory(4)", "Dorsal excitatory(5)"),
...
big_order <- c("Cholinergic", "Dorsal Maf", "Dorsal inhibitory", "Dorsal excitatory",
...
band_gap <- 0      # 层与层之间没有间隔
band_height <- 0.8 # 每条带的厚度

# 每个方法块的总高度
rows_per_method <- 3
method_spacing <- 0.3  # 方法之间的间距

# BIG在最上面 (offset = +2)
# SUB在中间 (offset = +1)
# IDENTITY在最下面 (offset = 0)
offset_ID <- 0
offset_SUB <- 1
offset_BIG <- 2
...
# ===================== 创建热图 =====================
# 创建y轴标签位置（每个方法的中间位置）
y_axis_breaks <- method_y_base + 1  # 每组3行的中间
...
output_file <- file.path(output_dir, "Hierarchical_heatmap_13methods_0503_F4_C_0126.pdf")
ggsave(output_file,
       plot = p, 
       width = 20, 
